...
# 2. mini-Ref-Gygovos
gygovos_category_dict = {
    'bottle': 1, 'car': 2, 'lego': 3, 'box': 4, 'toy': 5,  'watch': 6, 'wallet': 7, 'toaster': 8, 'kettle': 9,
    'lucky cat': 10, 'plush toy': 11
}

# 1. mini-Ref-Youtube-VOS
mini_ytvos_category_dict = {
    ...
    'mouse': 18, 'snail': 19, 'camel': 20, 'shark': 21, 'giraffe': 22, 'tiger': 23, 'frog': 24, 'cat': 25,
    'dolphin': 26, 'cow': 27, 'dog': 28, 'bear': 29, 'zebra': 30, 'airplane': 31, 'leopard': 32, 'fox': 33,
    'turtle': 34, 'deer': 35, 'train': 36, 'sedan': 37, 'sheep': 38, 'fish': 39, 'bird': 40, 'rabbit': 41,
    'duck': 42, 'snake': 43, 'monkey': 44, 'parrot': 45, 'lizard': 46, 'giant_panda': 47, 'person': 48
}
