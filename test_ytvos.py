...
def main(args):
    ...
    if args.dataset_file == 'sailvos':
        ...
        save_path_prefix = os.path.join(save_dir, 'sailvosf_0922')
        ...
        save_path_prefix = os.path.join(save_dir, 'ytvosf_0922')
    ...
    checkpoint = torch.load('ytvos/r50-24/group_1/checkpoint.pth', map_location='cpu')
