...
def main(args):
    ...
    dataset_train = build_yt_vos('train', data_path, set_index=args.group, support_frames=5, query_frames=5, sample_per_class=500)
    if args.distributed:
        if args.cache_mode:
    ...
    output_dir = os.path.join(args.output_dir, 'group_%d_nopre1' % args.group)
