...
from engine_gao import train_one_epoch, evaluate, evaluate_a2d
...
def main(args):
    ...
    if args.dataset_file == 'sailvos':
        ...
        save_path_prefix = os.path.join(save_dir, 'gygof_gao')
    ...
    print('number of params:', n_parameters)
    if args.dataset_file == 'sailvos':
        # checkpoint = torch.load('/ssd-nvme1/gaomingqi/few-referformer/sailvos/r50/checkpoint.pth', map_location='cpu')
