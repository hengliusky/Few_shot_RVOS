...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    for qsamples, qtargets, new_samples, new_targets,  _,  _, begin_new, _ in metric_logger.log_every(data_loader, print_freq, header):
        if begin_new[0]:
        ...
        # else:
        #     continue
        loss_dict = criterion(outputs, stargets)
