...
from models import build_model, few_build_model, few_build_model1, few_build_model2, few_build_model3, base_build_model
...
def main(args):
    ...
    model, criterion, postprocessor = base_build_model(args)
    model.to(device)
